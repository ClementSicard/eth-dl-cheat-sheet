...
\subsection{McCullogh-Pitts Neuron}

$
f(x;\sigma,\theta) =
\begin{cases} 
      1 & \sum_{i=1}^n{\sigma_i x_i} \geq \theta \\
      0
   \end{cases}
$ 
...
Neuron as (linear) boolean functions, no learning rule

\subsection{Turing unorganized machine}
Type A :

Networks of NAND units operating in a clocked fashion

$
y(t+1) = 1 - x_1(t) x_2(t) , \quad
x_1(t),x_2(t) \in \{0,1\}
$

Type B : controllable links, can make an universal machine
